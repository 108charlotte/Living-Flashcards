/*
    Living Flashcards Heatmap Renderer
    Adapted from Onigiri - draws heatmap graph based on review data
    with different views for Year, Month, and Week.
*/

// Ensure the LivingFlashcardsHeatmap object exists
window.LivingFlashcardsHeatmap = window.LivingFlashcardsHeatmap || {};
...
(function (exports) {
    ...
    function prepareData(rawData) {
        // Python sends date keys (YYYY-MM-DD) directly.
        // These keys are already adjusted for local timezone.
...
})(window.LivingFlashcardsHeatmap);
